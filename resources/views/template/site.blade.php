...
<html lang="en" dir="ltr">
    <head>
        ...
        <link rel="stylesheet" href="{{ url ('assets/vendor/owl.carousel.min.css')}}" />
        <link rel="stylesheet" href="{{ url ('assets/vendor/photoswipe.css')}}" />
        <link rel="stylesheet" href="{{ url ('assets/vendor/default-skin.css')}}" />
        <link rel="stylesheet" href="{{ url ('assets/vendor/select2.min.css')}}" />
        <link rel="stylesheet" href="{{ url ('assets/vendor/style.css')}}" />
        <!-- font - fontawesome -->
        <link rel="stylesheet" href="{{ url ('assets/vendor/all.min.css')}}" />
        <!-- font - stroyka -->
        <link rel="stylesheet" href="{{ url ('assets/vendor/stroyka.css')}}" />
    </head>
    <body>
        <!-- site -->
        <div class="site">
                                                ...
                                                <ul class="menu__list">
                                                    <li class="menu__item">
                                                        ...
                                                        <a class="menu__item-link" href="">
                                                            <div class="menu__item-icon"><img srcset="{{ url ('assets/imgs/languages/language-1.png')}}, images/languages/language-1.png@2x')}} 2x" src="{{ url ('assets/imgs/languages/language-1.png')}}" alt="" /></div>
                                                            English
                                                        </a>
                                                    </li>
                                                    <li class="menu__item">
                                                        ...
                                                        <div class="menu__item-submenu-offset"></div>
                                                        <a class="menu__item-link" href="">
                                                            <div class="menu__item-icon"><img srcset="{{ url ('assets/imgs/languages/language-2.png')}}, images/languages/language-2.png@2x')}} 2x" src="{{ url ('assets/imgs/languages/language-2.png')}}" alt="" /></div>
                                                            French
                                                        </a>
                                                    </li>
                                                    <li class="menu__item">
                                                        ...
                                                        <div class="menu__item-submenu-offset"></div>
                                                        <a class="menu__item-link" href="">
                                                            <div class="menu__item-icon"><img srcset="{{ url ('assets/imgs/languages/language-3.png')}}, images/languages/language-3.png@2x')}} 2x" src="{{ url ('assets/imgs/languages/language-3.png')}}" alt="" /></div>
                                                            German
                                                        </a>
                                                    </li>
                                                    <li class="menu__item">
                                                        ...
                                                        <div class="menu__item-submenu-offset"></div>
                                                        <a class="menu__item-link" href="">
                                                            <div class="menu__item-icon"><img srcset="{{ url ('assets/imgs/languages/language-4.png')}}, images/languages/language-4.png@2x')}} 2x" src="{{ url ('assets/imgs/languages/language-4.png')}}" alt="" /></div>
                                                            Russian
                                                        </a>
                                                    </li>
                                                    <li class="menu__item">
                                                        ...
                                                        <div class="menu__item-submenu-offset"></div>
                                                        <a class="menu__item-link" href="">
                                                            <div class="menu__item-icon"><img srcset="{{ url ('assets/imgs/languages/language-5.png')}}, images/languages/language-5.png@2x')}} 2x" src="{{ url ('assets/imgs/languages/language-5.png')}}" alt="" /></div>
                                                            Italian
                                                        </a>
                                                    </li>
                                                </ul>
                                        ...
                                        <ul class="nav-links__list">
                                            <li class="nav-links__item nav-links__item--has-submenu">
                                                <a class="nav-links__item-link" href="index.html">
                                                    <div class="nav-links__item-body">
                                                        Home <svg class="nav-links__item-arrow" width="9px" height="6px"><use xlink:href="images/sprite.svg#arrow-rounded-down-9x6"></use></svg>
                                                    </div>
                                                </a>
                                            ...
                                            <li class="nav-links__item nav-links__item--has-submenu">
                                                <a class="nav-links__item-link" href="">
                                                    <div class="nav-links__item-body">
                                                        Megamenu <svg class="nav-links__item-arrow" width="9px" height="6px"><use xlink:href="images/sprite.svg#arrow-rounded-down-9x6"></use></svg>
                                                    </div>
                                                </a>
                                            ...
                                            <li class="nav-links__item nav-links__item--has-submenu">
                                                <a class="nav-links__item-link" href="shop-grid-3-columns-sidebar.html">
                                                    <div class="nav-links__item-body">
                                                        Shop <svg class="nav-links__item-arrow" width="9px" height="6px"><use xlink:href="images/sprite.svg#arrow-rounded-down-9x6"></use></svg>
                                                    </div>
                                                </a>
                                                <div class="nav-links__submenu nav-links__submenu--type--menu">
                                                    <!-- .menu -->
                                                        ...
                                                        <ul class="menu__list">
                                                            <li class="menu__item">
                                                                ...
                                                                <a class="menu__item-link" href="shop-grid-3-columns-sidebar.html">
                                                                    Shop Grid <svg class="menu__item-arrow" width="6px" height="9px"><use xlink:href="images/sprite.svg#arrow-rounded-right-6x9"></use></svg>
                                                                </a>
                                                            ...
                                                            <li class="menu__item">
                                                                ...
                                                                <a class="menu__item-link" href="product.html">
                                                                    Product <svg class="menu__item-arrow" width="6px" height="9px"><use xlink:href="images/sprite.svg#arrow-rounded-right-6x9"></use></svg>
                                                                </a>
                                                                <div class="menu__submenu">
                                                                    <!-- .menu -->
                                                                    <div class="menu menu--layout--classic">
                                            ...
                                            <li class="nav-links__item nav-links__item--has-submenu">
                                                <a class="nav-links__item-link" href="account-login.html">
                                                    <div class="nav-links__item-body">
                                                        Account <svg class="nav-links__item-arrow" width="9px" height="6px"><use xlink:href="images/sprite.svg#arrow-rounded-down-9x6"></use></svg>
                                                    </div>
                                                </a>
                                                <div class="nav-links__submenu nav-links__submenu--type--menu">
                                                    <!-- .menu -->
                                            ...
                                            <li class="nav-links__item nav-links__item--has-submenu">
                                                <a class="nav-links__item-link" href="blog-classic.html">
                                                    <div class="nav-links__item-body">
                                                        Blog <svg class="nav-links__item-arrow" width="9px" height="6px"><use xlink:href="images/sprite.svg#arrow-rounded-down-9x6"></use></svg>
                                                    </div>
                                                </a>
                                                <div class="nav-links__submenu nav-links__submenu--type--menu">
                                                    <!-- .menu -->
                                            ...
                                            <li class="nav-links__item nav-links__item--has-submenu">
                                                <a class="nav-links__item-link" href="">
                                                    <div class="nav-links__item-body">
                                                        Pages <svg class="nav-links__item-arrow" width="9px" height="6px"><use xlink:href="images/sprite.svg#arrow-rounded-down-9x6"></use></svg>
                                                    </div>
                                                </a>
                                                <div class="nav-links__submenu nav-links__submenu--type--menu">
                                                    <!-- .menu -->
                                            ...
                                            <li class="nav-links__item">
                                                <a class="nav-links__item-link" href="https://themeforest.net/item/stroyka-tools-store-html-template/23326943"><div class="nav-links__item-body">Buy Theme</div></a>
                                            </li>
                                        </ul>
                                    </div>
                                    <!-- .nav-links / end -->
                                    <div class="nav-panel__indicators">
                                                        ...
                                                        <div class="dropcart__products-list">
                                                            <div class="dropcart__product">
                                                                <div class="product-image dropcart__product-image">
                                                                    <a href="product.html" class="product-image__body"><img class="product-image__img" src="{{ url ('assets/imgs/products/product-1.jpg')}}" /></a>
                                                                </div>
                                                            ...
                                                            <div class="dropcart__product">
                                                                <div class="product-image dropcart__product-image">
                                                                    <a href="product.html" class="product-image__body"><img class="product-image__img" src="{{ url ('assets/imgs/products/product-2.jpg')}} " alt="" /></a>
                                                                </div>
                                                                <div class="dropcart__product-info">
                                                            ...
                                                            <div class="dropcart__product">
                                                                <div class="product-image dropcart__product-image">
                                                                    <a href="product.html" class="product-image__body"><img class="product-image__img" src="{{ url ('assets/imgs/products/product-5.jpg')}} " alt="" /></a>
                                                                </div>
                                                                <div class="dropcart__product-info">
                                        ...
                                        <div class="indicator indicator--trigger--click">
                                            <a href="account-login.html" class="indicator__button">
                                                <span class="indicator__area">
                                                    <svg width="20px" height="20px"><use xlink:href="images/sprite.svg#person-20"></use></svg>
                                                </span>
                                            </a>
                                            <div class="indicator__dropdown">
                                                <div class="account-menu">
                                                    ...
                                                    <a href="account-dashboard.html" class="account-menu__user">
                                                        <div class="account-menu__user-avatar"><img src="{{ url ('assets/imgs/avatares/avatar-3.jpg')}} " alt="" /></div>
                                ...
                                <div class="block-slideshow__body">
                                    <div class="owl-carousel">
                                        <a class="block-slideshow__slide" href="">
                                            <div class="block-slideshow__slide-image block-slideshow__slide-image--desktop" style="background-image: url('{{ url ('assets/imgs/slides/slide-1.jpg')}} ');"></div>
                                            <div class="block-slideshow__slide-image block-slideshow__slide-image--mobile" style="background-image: url('{{ url ('assets/imgs/slides/slide-1-mobile.jpg')}} ');"></div>
                                        ...
                                        <a class="block-slideshow__slide" href="">
                                            <div class="block-slideshow__slide-image block-slideshow__slide-image--desktop" style="background-image: url('{{ url ('assets/imgs/slides/slide-2.jpg')}} ');"></div>
                                            <div class="block-slideshow__slide-image block-slideshow__slide-image--mobile" style="background-image: url('{{ url ('assets/imgs/slides/slide-2-mobile.jpg')}} ');"></div>
                                            <div class="block-slideshow__slide-content">
                                                <div class="block-slideshow__slide-title">
                                                    Screwdrivers<br />
                                                    Professional Tools
                                        ...
                                        <a class="block-slideshow__slide" href="">
                                            <div class="block-slideshow__slide-image block-slideshow__slide-image--desktop" style="background-image: url('{{ url ('assets/imgs/slides/slide-3.jpg')}} ');"></div>
                                            <div class="block-slideshow__slide-image block-slideshow__slide-image--mobile" style="background-image: url('{{ url ('assets/imgs/slides/slide-3-mobile.jpg')}} ');"></div>
                                            <div class="block-slideshow__slide-content">
                                                <div class="block-slideshow__slide-title">
                                                    One more<br />
                                                    Unique header
                        ...
                        <div class="block-header">
                            ...
                            <div class="block-header__arrows-list">
                                <button class="block-header__arrow block-header__arrow--left" type="button">
                                    <svg width="7px" height="11px"><use xlink:href="images/sprite.svg#arrow-rounded-left-7x11"></use></svg>
                                </button>
                                <button class="block-header__arrow block-header__arrow--right" type="button">
                                    <svg width="7px" height="11px"><use xlink:href="images/sprite.svg#arrow-rounded-right-7x11"></use></svg>
                                </button>
                            </div>
                        </div>
                                    ...
                                    <div class="block-products-carousel__cell">
                                        <div class="product-card product-card--hidden-actions">
                                            <button class="product-card__quickview" type="button">
                                                <svg width="16px" height="16px"><use xlink:href="images/sprite.svg#quickview-16"></use></svg> <span class="fake-svg-icon"></span>
                                            </button>
                                            <div class="product-card__badges-list"><div class="product-card__badge product-card__badge--new">New</div></div>
                                            <div class="product-card__image product-image">
                                                <a href="product.html" class="product-image__body"><img class="product-image__img" src="{{ url ('assets/imgs/products/product-1.jpg')}} " alt="" /></a>
                                            </div>
                                            ...
                                            <div class="product-card__actions">
                                                ...
                                                <div class="product-card__buttons">
                                                    ...
                                                    <button class="btn btn-light btn-svg-icon btn-svg-icon--fake-svg product-card__wishlist" type="button">
                                                        <svg width="16px" height="16px"><use xlink:href="images/sprite.svg#wishlist-16"></use></svg> <span class="fake-svg-icon fake-svg-icon--wishlist-16"></span>
                                                    </button>
                                                    <button class="btn btn-light btn-svg-icon btn-svg-icon--fake-svg product-card__compare" type="button">
                                                        <svg width="16px" height="16px"><use xlink:href="images/sprite.svg#compare-16"></use></svg> <span class="fake-svg-icon fake-svg-icon--compare-16"></span>
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="block-products-carousel__column">
                                    <div class="block-products-carousel__cell">
                                        <div class="product-card product-card--hidden-actions">
                                            ...
                                            <div class="product-card__image product-image">
                                                <a href="product.html" class="product-image__body"><img class="product-image__img" src="{{ url ('assets/imgs/products/product-3.jpg')}} " alt="" /></a>
                                            </div>
                                            <div class="product-card__info">
                                ...
                                <div class="block-products-carousel__column">
                                    <div class="block-products-carousel__cell">
                                        <div class="product-card product-card--hidden-actions">
                                            ...
                                            <div class="product-card__image product-image">
                                                <a href="product.html" class="product-image__body"><img class="product-image__img" src="{{ url ('assets/imgs/products/product-4.jpg')}} " alt="" /></a>
                                            </div>
                                            <div class="product-card__info">
                                ...
                                <div class="block-products-carousel__column">
                                    <div class="block-products-carousel__cell">
                                        <div class="product-card product-card--hidden-actions">
                                            ...
                                            <div class="product-card__image product-image">
                                                <a href="product.html" class="product-image__body"><img class="product-image__img" src="{{ url ('assets/imgs/products/product-6.jpg')}} " alt="" /></a>
                                            </div>
                                            <div class="product-card__info">
                                ...
                                <div class="block-products-carousel__column">
                                    <div class="block-products-carousel__cell">
                                        <div class="product-card product-card--hidden-actions">
                                            ...
                                            <div class="product-card__image product-image">
                                                <a href="product.html" class="product-image__body"><img class="product-image__img" src="{{ url ('assets/imgs/products/product-7.jpg')}} " alt="" /></a>
                                            </div>
                                            <div class="product-card__info">
                                ...
                                <div class="block-products-carousel__column">
                                    <div class="block-products-carousel__cell">
                                        <div class="product-card product-card--hidden-actions">
                                            ...
                                            <div class="product-card__image product-image">
                                                <a href="product.html" class="product-image__body"><img class="product-image__img" src="{{ url ('assets/imgs/products/product-8.jpg')}} " alt="" /></a>
                                            </div>
                                            <div class="product-card__info">
                                ...
                                <div class="block-products-carousel__column">
                                    <div class="block-products-carousel__cell">
                                        <div class="product-card product-card--hidden-actions">
                                            ...
                                            <div class="product-card__image product-image">
                                                <a href="product.html" class="product-image__body"><img class="product-image__img" src="{{ url ('assets/imgs/products/product-9.jpg')}} " alt="" /></a>
                                            </div>
                                            <div class="product-card__info">
                                ...
                                <div class="block-products-carousel__column">
                                    <div class="block-products-carousel__cell">
                                        <div class="product-card product-card--hidden-actions">
                                            ...
                                            <div class="product-card__image product-image">
                                                <a href="product.html" class="product-image__body"><img class="product-image__img" src="{{ url ('assets/imgs/products/product-10.jpg')}} " alt="" /></a>
                                            </div>
                                            <div class="product-card__info">
                                ...
                                <div class="block-products-carousel__column">
                                    <div class="block-products-carousel__cell">
                                        <div class="product-card product-card--hidden-actions">
                                            ...
                                            <div class="product-card__image product-image">
                                                <a href="product.html" class="product-image__body"><img class="product-image__img" src="{{ url ('assets/imgs/products/product-11.jpg')}} " alt="" /></a>
                                            </div>
                                            <div class="product-card__info">
                                ...
                                <div class="block-products-carousel__column">
                                    <div class="block-products-carousel__cell">
                                        <div class="product-card product-card--hidden-actions">
                                            ...
                                            <div class="product-card__image product-image">
                                                <a href="product.html" class="product-image__body"><img class="product-image__img" src="{{ url ('assets/imgs/products/product-12.jpg')}} " alt="" /></a>
                                            </div>
                                            <div class="product-card__info">
                                ...
                                <div class="block-products-carousel__column">
                                    <div class="block-products-carousel__cell">
                                        <div class="product-card product-card--hidden-actions">
                                            ...
                                            <div class="product-card__image product-image">
                                                <a href="product.html" class="product-image__body"><img class="product-image__img" src="{{ url ('assets/imgs/products/product-13.jpg')}} " alt="" /></a>
                                            </div>
                                            <div class="product-card__info">
                                ...
                                <div class="block-products-carousel__column">
                                    <div class="block-products-carousel__cell">
                                        <div class="product-card product-card--hidden-actions">
                                            ...
                                            <div class="product-card__image product-image">
                                                <a href="product.html" class="product-image__body"><img class="product-image__img" src="{{ url ('assets/imgs/products/product-14.jpg')}} " alt="" /></a>
                                            </div>
                                            <div class="product-card__info">
                                ...
                                <div class="block-products-carousel__column">
                                    <div class="block-products-carousel__cell">
                                        <div class="product-card product-card--hidden-actions">
                                            ...
                                            <div class="product-card__image product-image">
                                                <a href="product.html" class="product-image__body"><img class="product-image__img" src="{{ url ('assets/imgs/products/product-15.jpg')}} " alt="" /></a>
                                            </div>
                                            <div class="product-card__info">
                                ...
                                <div class="block-products-carousel__column">
                                    <div class="block-products-carousel__cell">
                                        <div class="product-card product-card--hidden-actions">
                                            ...
                                            <div class="product-card__image product-image">
                                                <a href="product.html" class="product-image__body"><img class="product-image__img" src="{{ url ('assets/imgs/products/product-16.jpg')}} " alt="" /></a>
                                            </div>
                                            <div class="product-card__info">
                ...
                <div class="block block-banner">
                    <div class="container">
                        <a href="" class="block-banner__body">
                            <div class="block-banner__image block-banner__image--desktop" style="background-image: url('{{ url ('assets/imgs/banners/banner-1.jpg')}} ');"></div>
                            <div class="block-banner__image block-banner__image--mobile" style="background-image: url('{{ url ('assets/imgs/banners/banner-1-mobile.jpg')}} ');"></div>
                    ...
                    <div class="container">
                        ...
                        <div class="block-categories__list">
                            <div class="block-categories__item category-card category-card--layout--classic">
                                <div class="category-card__body">
                                    <div class="category-card__image">
                                        <a href=""><img src="{{ url ('assets/imgs/categories/category-1.jpg')}} " alt="" /></a>
                                    </div>
                            ...
                            <div class="block-categories__item category-card category-card--layout--classic">
                                <div class="category-card__body">
                                    <div class="category-card__image">
                                        <a href=""><img src="{{ url ('assets/imgs/categories/category-2.jpg')}} " alt="" /></a>
                                    </div>
                                    <div class="category-card__content">
                            ...
                            <div class="block-categories__item category-card category-card--layout--classic">
                                <div class="category-card__body">
                                    <div class="category-card__image">
                                        <a href=""><img src="{{ url ('assets/imgs/categories/category-4.jpg')}} " alt="" /></a>
                                    </div>
                                    <div class="category-card__content">
                            ...
                            <div class="block-categories__item category-card category-card--layout--classic">
                                <div class="category-card__body">
                                    <div class="category-card__image">
                                        <a href=""><img src="{{ url ('assets/imgs/categories/category-3.jpg')}} " alt="" /></a>
                                    </div>
                                    <div class="category-card__content">
                            ...
                            <div class="block-categories__item category-card category-card--layout--classic">
                                <div class="category-card__body">
                                    <div class="category-card__image">
                                        <a href=""><img src="{{ url ('assets/imgs/categories/category-5.jpg')}} " alt="" /></a>
                                    </div>
                                    <div class="category-card__content">
                            ...
                            <div class="block-categories__item category-card category-card--layout--classic">
                                <div class="category-card__body">
                                    <div class="category-card__image">
                                        <a href=""><img src="{{ url ('assets/imgs/categories/category-6.jpg')}} " alt="" /></a>
                                    </div>
                                    <div class="category-card__content">
                            ...
                            <div class="owl-carousel">
                                <div class="post-card">
                                    <div class="post-card__image">
                                        <a href=""><img src="{{ url ('assets/imgs/posts/post-1.jpg')}} " alt="" /></a>
                                    </div>
                                ...
                                <div class="post-card">
                                    <div class="post-card__image">
                                        <a href=""><img src="{{ url ('assets/imgs/posts/post-2.jpg')}} " alt="" /></a>
                                    </div>
                                    <div class="post-card__info">
                                ...
                                <div class="post-card">
                                    <div class="post-card__image">
                                        <a href=""><img src="{{ url ('assets/imgs/posts/post-3.jpg')}} " alt="" /></a>
                                    </div>
                                    <div class="post-card__info">
                                ...
                                <div class="post-card">
                                    <div class="post-card__image">
                                        <a href=""><img src="{{ url ('assets/imgs/posts/post-4.jpg')}} " alt="" /></a>
                                    </div>
                                    <div class="post-card__info">
                                        <div class="post-card__category"><a href="">Special Offers</a></div>
                                ...
                                <div class="post-card">
                                    <div class="post-card__image">
                                        <a href=""><img src="{{ url ('assets/imgs/posts/post-5.jpg')}} " alt="" /></a>
                                    </div>
                                    <div class="post-card__info">
                                        <div class="post-card__category"><a href="">New Arrivals</a></div>
                                ...
                                <div class="post-card">
                                    <div class="post-card__image">
                                        <a href=""><img src="{{ url ('assets/imgs/posts/post-6.jpg')}} " alt="" /></a>
                                    </div>
                                    <div class="post-card__info">
                                        <div class="post-card__category"><a href="">Special Offers</a></div>
                                ...
                                <div class="post-card">
                                    <div class="post-card__image">
                                        <a href=""><img src="{{ url ('assets/imgs/posts/post-7.jpg')}} " alt="" /></a>
                                    </div>
                                    <div class="post-card__info">
                                        <div class="post-card__category"><a href="">Special Offers</a></div>
                                ...
                                <div class="post-card">
                                    <div class="post-card__image">
                                        <a href=""><img src="{{ url ('assets/imgs/posts/post-8.jpg')}} " alt="" /></a>
                                    </div>
                                    <div class="post-card__info">
                                        <div class="post-card__category"><a href="">Latest News</a></div>
                                ...
                                <div class="post-card">
                                    <div class="post-card__image">
                                        <a href=""><img src="{{ url ('assets/imgs/posts/post-9.jpg')}} " alt="" /></a>
                                    </div>
                                    <div class="post-card__info">
                                        <div class="post-card__category"><a href="">New Arrivals</a></div>
                                ...
                                <div class="post-card">
                                    <div class="post-card__image">
                                        <a href=""><img src="{{ url ('assets/imgs/posts/post-10.jpg')}} " alt="" /></a>
                                    </div>
                                    <div class="post-card__info">
                                        <div class="post-card__category"><a href="">Special Offers</a></div>
                        ...
                        <div class="block-brands__slider">
                            <div class="owl-carousel">
                                <div class="block-brands__item">
                                    <a href=""><img src="{{ url ('assets/imgs/logos/logo-1.png')}}" alt="" /></a>
                                </div>
                                <div class="block-brands__item">
                                    <a href=""><img src="{{ url ('assets/imgs/logos/logo-2.png')}}" alt="" /></a>
                                </div>
                                <div class="block-brands__item">
                                    <a href=""><img src="{{ url ('assets/imgs/logos/logo-3.png')}}" alt="" /></a>
                                </div>
                                <div class="block-brands__item">
                                    <a href=""><img src="{{ url ('assets/imgs/logos/logo-4.png')}}" alt="" /></a>
                                </div>
                                <div class="block-brands__item">
                                    <a href=""><img src="{{ url ('assets/imgs/logos/logo-5.png')}}" alt="" /></a>
                                </div>
                                <div class="block-brands__item">
                                    <a href=""><img src="{{ url ('assets/imgs/logos/logo-6.png')}}" alt="" /></a>
                                </div>
                                <div class="block-brands__item">
                                    <a href=""><img src="{{ url ('assets/imgs/logos/logo-7.png')}}" alt="" /></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="site-footer">
                    <div class="container">
                                        ...
                                        <div class="social-links footer-newsletter__social-links social-links--shape--circle">
                                            <ul class="social-links__list">
                                                <li class="social-links__item">
                                                    <a class="social-links__link social-links__link--type--rss" href="" target="_blank"><i class="fas fa-rss"></i></a>
                                                </li>
                                                <li class="social-links__item">
                        ...
                        <div class="site-footer__bottom">
                            ...
                            <div class="site-footer__payments"><img src="{{ url ('assets/imgs/payments.png')}}" alt="" /></div>
                        </div>
                    </div>
                    <div class="totop">
                        <div class="totop__body">
                            ...
                            <div class="totop__end">
                                <button type="button" class="totop__button">
                                    <svg width="13px" height="8px"><use xlink:href="images/sprite.svg#arrow-rounded-up-13x8"></use></svg>
                                </button>
                            </div>
                        </div>
                    </div>
        ...
        <script src="{{ url ('assets/js/photoswipe.min.js')}}"></script>
        <script src="{{ url ('assets/js/photoswipe-ui-default.min.js')}}"></script>
        <script src="{{ url ('assets/js/select2.min.js')}}"></script>
        <script src="{{ url ('assets/js/number.js')}}"></script>
        <script src="{{ url ('assets/js/main.js')}}"></script>
        <script src="{{ url ('assets/js/header.js')}}"></script>
        <script src="{{ url ('assets/js/svg4everybody.min.js')}}"></script>
        <script>
            svg4everybody();
        </script>
    </body>
